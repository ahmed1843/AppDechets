...
export default function ProfileScreen() {
  ...
  const fetchUser = async () => {
    try {
      // ✅ D'abord charger depuis AsyncStorage (instantané, offline)
      ...
      // ✅ Ensuite rafraîchir depuis l'API avec le token
        ...
        { text: "Annuler", style: "cancel" },
        {
          ...
          onPress: async () => {
            try {
              ...
              // ✅ Toujours vider AsyncStorage et rediriger
              await logout();
              router.replace('/login');
            }
          },
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.profileCard}>
          <View style={styles.avatarContainer}>
            {/* ✅ Avatar avec initiale du vrai nom */}
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                item.route
                  ...
                  : Alert.alert("Bientôt", "Disponible prochainement")
              }
            >
...
const styles = StyleSheet.create({
  ...
  editAvatar: {
    ...
    backgroundColor: '#166534', width: 32, height: 32,
  ...
  streetBadge: {
    ...
    borderRadius: 20, marginTop: 8, borderWidth: 1, borderColor: '#bbf7d0',
  },
  ...
  input: {
    ...
    padding: 14, fontSize: 15, marginBottom: 14, color: '#1e293b',
  },
  ...
  menuSection: {
    ...
    borderRadius: 20, padding: 8, marginBottom: 16,
  },
