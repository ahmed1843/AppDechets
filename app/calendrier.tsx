...
const DAY_COLORS: Record<string, string> = {
  ...
  Jeudi: '#3b82f6', Vendredi: '#8b5cf6', Samedi: '#ec4899', Dimanche: '#64748b',
};

const DAYS_FR = ['Dimanche', 'Lundi', 'Mardi', 'Mercredi', 'Jeudi', 'Vendredi', 'Samedi'];
const todayFr = DAYS_FR[new Date().getDay()];
// Ajoute cette fonction avant le composant
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.todayBadge}>
          ...
          <Text style={styles.todayText}>Aujourd'hui : <Text style={{ fontWeight: '700' }}>{todayFr}</Text></Text>
        </View>
...
zoneTime: { fontSize: 13, color: '#1e293b', fontWeight: '500' },
  ...
  retryBtn:   { backgroundColor: '#166534', borderRadius: 20, paddingHorizontal: 20, paddingVertical: 8, marginTop: 4 },
